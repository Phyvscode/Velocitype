...
const oldBattery = `<div className="w-8 h-4 rounded-sm border-2 border-slate-700 relative overflow-hidden flex bg-slate-900/50">
          <div 
...
code = code.replace(oldBattery, newBattery);
