          ...
          {activeTab === 'solid' ? (
            <div className="flex flex-col items-center justify-center py-6">
              <button 
                ...
                className="mb-8 px-6 py-2 border border-slate-700 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-mono uppercase tracking-widest rounded transition-colors"
              >
